...
estimation_path = '/home/fan/3d-pose-baseline-master/'
...
tf.app.flags.DEFINE_string("cameras_path",estimation_path + "data/h36m/cameras.h5","Directory to load camera parameters")
tf.app.flags.DEFINE_string("data_dir",   estimation_path + "data/h36m/", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "experiments", "Training directory.")

# openpose
tf.app.flags.DEFINE_string("pose", "3dpose_output", "3dpose output Data directory")
